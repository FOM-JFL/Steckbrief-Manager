@echo off
chcp 65001 >nul
title Steckbrief Manager (Prozesse ^& Projekte) - FOM (V16.0)
echo.
echo  ================================================
...
if errorlevel 1 (
    echo  Installiere PyJWT...
    pip install pyjwt >nul 2>&1
)
python -c "import ldap3" >nul 2>&1
if errorlevel 1 (
    echo  Installiere ldap3...
    pip install ldap3 >nul 2>&1
)
python -c "import dotenv" >nul 2>&1
if errorlevel 1 (
    echo  Installiere python-dotenv...
